...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center">
            ...
            <Image alt="logo" width={54} height={54} src={ImageURL} />
          </div>
          <div className="flex flex-col text-left leading-tight">
            <span className="text-[30px] font-bold text-[var(--text-primary)]">
              Solera
            </span>
            <span className="font-mono text-[16px] text-[var(--text-muted)]">
              multi-agent
            </span>
          </div>
        </div>
      ...
      <Card className="border-[var(--border-subtle)] bg-[var(--bg-card)] ring-0 p-8">
