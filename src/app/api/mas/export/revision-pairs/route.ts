...
const PAIR_COLUMNS = [
  ...
  { header: "beforeOverall", key: "beforeOverall" },
  { header: "beforeDecision", key: "beforeDecision", width: 10 },
  { header: "beforeClarity", key: "beforeClarity" },
  { header: "beforeRelevance", key: "beforeRelevance" },
  { header: "beforeProfessional", key: "beforeProfessional" },
  { header: "beforeEngagement", key: "beforeEngagement" },
  { header: "beforeChars", key: "beforeChars" },
  { header: "afterLabel", key: "afterLabel" },
  { header: "afterVersion", key: "afterVersion" },
  { header: "afterOverall", key: "afterOverall" },
  { header: "afterDecision", key: "afterDecision", width: 10 },
  { header: "afterClarity", key: "afterClarity" },
  { header: "afterRelevance", key: "afterRelevance" },
  { header: "afterProfessional", key: "afterProfessional" },
  { header: "afterEngagement", key: "afterEngagement" },
  { header: "afterChars", key: "afterChars" },
  { header: "deltaOverall", key: "deltaOverall" },
...
function pairRow(p: RevisionPair) {
  ...
  return {
    ...
    beforeOverall: b?.overall ?? "",
    beforeDecision: b?.decision ?? "",
    beforeClarity: b?.clarity ?? "",
    beforeRelevance: b?.relevance ?? "",
    beforeProfessional: b?.professional ?? "",
    beforeEngagement: b?.engagement ?? "",
    beforeChars: p.before.charCount,
    afterLabel: p.after.label ?? "",
    afterVersion: p.after.version,
    afterOverall: a?.overall ?? "",
    afterDecision: a?.decision ?? "",
    afterClarity: a?.clarity ?? "",
    afterRelevance: a?.relevance ?? "",
    afterProfessional: a?.professional ?? "",
    afterEngagement: a?.engagement ?? "",
    afterChars: p.after.charCount,
    deltaOverall: p.deltaScore ?? "",
    ...
    // vive no check_provenance() do quality_study.py. `rubricVersion` é o
    // filtro grosso (v1 é escala 0–10, v2 é 1–5 — não se misturam).
    rubricVersion: p.after.judgeMeta?.rubricVersion ?? "",
...
function versionRow(
  ...
  return {
    ...
    rubricVersion: v.judgeMeta?.rubricVersion ?? "",
